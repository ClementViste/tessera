...
/// Representation of a ticket's title.
#[derive(Debug)]
pub struct TicketTitle(String);

impl TicketTitle {
    /// Returns a valid ticket title.
    pub fn parse(s: String) -> Result<Self, String> {
        ...
        if is_empty_or_whitespace {
            Err("ticket title cannot be empty.".to_string())
        } else if is_too_long {
            Err("ticket title cannot be longer than 256 characters.".to_string())
        } else {
            Ok(Self(s))
        }
    }
...
mod tests {
    ...
    #[test]
    fn ticket_title_returns_err_when_empty() {
        let name = "".to_string();
    ...
    #[test]
    fn ticket_title_returns_err_when_filled_with_whitespace() {
        let name = " ".to_string();
        assert_err!(TicketTitle::parse(name));
    }
    ...
    #[test]
    fn ticket_title_returns_ok_when_not_too_long() {
    ...
    #[test]
    fn ticket_title_returns_err_when_too_long() {
    ...
    #[test]
    fn ticket_title_returns_ok_when_valid() {
